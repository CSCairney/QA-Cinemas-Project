...
const ListingLatestTotal = () => {
    ...
    useEffect(() => {
        ...
        axios.get('https://qacinema-362612.ey.r.appspot.com/movies/getByLatest/5')
            .then((result) => {
                                ...
                                <div className="listingTextArea">
                                    <div className="listingMainDetails">
                                        ...
                                        <div className="listingStaff">
                                            ...
                                            <p className="staffingInfo"><span className="listingHighlight"><strong>Actors: </strong></span>{movie.actors.join(', ')}</p>
                                        </div>
